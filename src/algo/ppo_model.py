...
from src.algo.intrinsic_rewards.aegis import AEGIS
...
class PPOModel(ActorCriticCnnPolicy):
    def __init__(
        ...
        self.dim_policy_features = self.features_extractor_kwargs['features_dim']
        ...
        if sde_net_arch is not None:
            self.features_extractor_kwargs['sde_net_arch'] = sde_net_arch
    ...
    def extract_features(self, obs: Tensor, mem: Tensor) -> Tuple[Tensor, Tensor, Tensor]:
    ...
    def forward(self, obs: Tensor, mem: Tensor, deterministic: bool = False) \
        ...
        latent_pi, latent_vf, memories = self.extract_features(obs, mem)
