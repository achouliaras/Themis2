...
class TrainingConfig():
    ...
    def get_activation_fn(self):
        ...
        if self.reward_activation_fn.lower() == 'relu':
            reward_activation_fn = nn.ReLU
        elif self.reward_activation_fn.lower() == 'gelu':
            reward_activation_fn = nn.GELU
        elif self.reward_activation_fn.lower() == 'elu':
            reward_activation_fn = nn.ELU
        else:
            raise NotImplementedError

        return activation_fn, cnn_activation_fn, reward_activation_fn
